...
class Symbol {
	...
	// CHANGED. Same as above for the new private members.
	virtual int &get_num_args();
	virtual int get_num_args() const;

	/*virtual int &get_has_return();
	virtual	int get_has_return();*/
	
	virtual void set_num_args(int argnum);
	virtual void set_has_return(bool hasret);
